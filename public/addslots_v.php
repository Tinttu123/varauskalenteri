...
<head>
  ...
  <link rel="stylesheet" href="css/slots.css"> <!-- uusi tiedosto -->
    ...
    <div class="calendar-layout">
      ...
      <div class="add-slot">
        ...
        <form action="calendar.php" method="post">
          ...
          <input type="datetime-local" name="start_time" id="start_time" step="300" required><br><br>

          <label>Lopetusaika:</label><br>
          <input type="datetime-local" name="end_time" id="end_time" step="300" required><br><br>
